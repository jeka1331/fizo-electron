...
const russianMessages: TranslationMessages = {
    ra: {
        ...
        input: {
            file: {
                upload_several: 'Перетащите файлы для загрузки или кликните для выбора.',
                upload_single: 'Перетащите файл для загрузки или кликните для выбора.',
            },
            image: {
                upload_several: 'Перетащите изображения для загрузки или кликните для выбора.',
                upload_single: 'Перетащите изображение для загрузки или кликните для выбора.',
            },
            references: {
        ...
        message: {
            ...
            bulk_delete_content: 'Вы уверены, что хотите удалить этот %{name}? |||| Вы уверены, что хотите удалить эти %{smart_count} элементов?',
            bulk_delete_title: 'Удалить %{name} |||| Удалить %{smart_count} %{name}',
            bulk_update_content: 'Вы уверены, что хотите обновить этот %{name}? |||| Вы уверены, что хотите обновить эти %{smart_count} элементов?',
            ...
            details: 'Детали',
            error: 'Произошла ошибка на стороне клиента, и ваш запрос не может быть выполнен.',
            invalid_form: 'Форма невалидна. Пожалуйста, проверьте на ошибки',
            loading: 'Пожалуйста, подождите',
            no: 'Нет',
            not_found: 'Либо вы набрали неправильный URL, либо перешли по неправильной ссылке.',
            yes: 'Да',
            unsaved_changes: 'Некоторые из ваших изменений не сохранены. Вы уверены, что хотите их игнорировать?',
        },
        navigation: {
            no_results: 'Результаты не найдены',
            no_more_results: 'Номер страницы %{page} вне границ. Попробуйте предыдущую страницу.',
        ...
        validation: {
            ...
            regex: 'Должно соответствовать определенному формату (regexp): %{pattern}',
        ...
        configurable: {
            ...
            inspector: {
                title: 'Инспектор',
                content: 'Наведите на элементы пользовательского интерфейса приложения, чтобы настроить их',
