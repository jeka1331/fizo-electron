...
const kazakhMessages: TranslationMessages = {
    ra: {
        ...
        input: {
            file: {
                upload_several: 'Жүктеу үшін файлдарды ауыстыру немесе таңдау үшін басыңыз.',
                upload_single: 'Жүктеу үшін файлды ауыстыру немесе таңдау үшін басыңыз.',
            },
            image: {
                upload_several: 'Жүктеу үшін суреттерді ауыстыру немесе таңдау үшін басыңыз.',
                upload_single: 'Жүктеу үшін суретті ауыстыру немесе таңдау үшін басыңыз.',
            },
            references: {
        ...
        message: {
            ...
            bulk_delete_content: 'Бұл %{name}ді жою керек пе? |||| Сіз %{smart_count} элементін жою керек пе?',
            bulk_delete_title: '%{name}ді жою |||| %{smart_count} %{name}ді жою',
            bulk_update_content: 'Бұл %{name}ді жаңарту керек пе? |||| Сіз %{smart_count} элементті жаңарту керек пе?',
            bulk_update_title: '%{name}ді жаңарту |||| %{smart_count} %{name}ді жаңарту',
            ...
            no: 'Жоқ',
            not_found: 'Сілтемені дұрыс енгізбегеніңіз немесе дұрыс сілтемеге өтініш жібербегеніңіз көріңіз.',
            yes: 'Иә',
            unsaved_changes: 'Сіздің өзгерістеріңізден кейінде кейінірек сақталмаған. Оларды жоққа көтеруге сенімдісіз пе?',
        },
        navigation: {
            no_results: 'Нәтиже табылмады',
            no_more_results: '%{page} бет нөмірі шектеулердің сыртқы шектесінен тыс. Алдыңғы бетке қайтыңыз.',
            page_out_of_boundaries: '%{page} бет нөмірі шектеулердің сыртқы шектесінен тыс',
            ...
            partial_page_range_info: '%{offsetEnd}-нан астам %{offsetBegin}-%{total} шегі',
        ...
        notification: {
            ...
            data_provider_error: 'dataProvider қатесі. Егжей-тегжейліліктерді тексеру үшін консолге қараңыз.',
        ...
        saved_queries: {
            ...
            remove_message: 'Сіз сақталған сұраулар тізімінен бұл элементті жою керек пе?',
        ...
        configurable: {
            ...
            inspector: {
                title: 'Инспектор',
                content: 'Қосымша интерфейс элементтерін қалыптастыру үшін қолданба элементтерін ашыңыз',
